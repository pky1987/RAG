...
class OllamaServerInfos:
    ...
    # Backwards-compatible aliases (older code expects LIGHTRAG_* attributes)
    @property
    ...
    @property
    def LIGHTRAG_SIZE(self):
        return self.RAG_SIZE

    @property
    def LIGHTRAG_CREATED_AT(self):
        return self.RAG_CREATED_AT

    @property
    def LIGHTRAG_DIGEST(self):
        return self.RAG_DIGEST
